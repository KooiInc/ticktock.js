...
function instanceCreator({localeInfo, customMethods, dateValue} = {}) {
  ...
  const customDateExtensions = {
    ...
    next(day, preserveTodayWhenEqual) { return nextOrPrevious(instance, {day, next: true, preserveTodayWhenEqual}); },
    offsetFrom(date) { return offsetFrom(instance, date); },
    previous(day, preserveTodayWhenEqual) { return nextOrPrevious(instance, {day, next: false, preserveTodayWhenEqual}); },
